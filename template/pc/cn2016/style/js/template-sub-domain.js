(function (f) {
    var a = " .webcompatibleCon{ " +
            ...
            '    width: 26px; height: 26px; background:url("http://www.ksmrk.com/js/BrowserTip.png") no-repeat -7px -195px; } ' +
            ...
            '.webcompatibleCon .browser{ width: 56px; height: 58px; display: inline-block; margin:0 auto; background-image:url("http://www.ksmrk.com/js/BrowserTip.png"); background-repeat:no-repeat; }' +
